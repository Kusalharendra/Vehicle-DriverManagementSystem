...
<body style="margin:50px;">
    ...
    <h2 class="display-6">Driver Details</h2>
    <br>
    ...
    <table class="table table-hover table-bordered border-primary">
        ...
        <tbody>
            ...
            $conn = OpenCon();
            $query = "SELECT * from driver where portId = '$portId'";
    ...
    <a class="btn btn-primary" href="../view/viewDriver.php" role="button">Back</a>
    <a class="btn btn-primary" href="../view/home.php" role="button">Home</a>
